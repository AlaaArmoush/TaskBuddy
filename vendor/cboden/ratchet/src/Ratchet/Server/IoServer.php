...
class IoServer {
    ...
    /**
     * @param MessageComponentInterface $app      The Ratchet application stack to host
    ...
    /**
     * @param MessageComponentInterface $component  The application that I/O will call when events are received
