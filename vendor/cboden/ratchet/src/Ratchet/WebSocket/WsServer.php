...
class WsServer implements HttpServerInterface {
    ...
    /**
     * @param MessageComponentInterface|DataComponentInterface $component Your application to run with WebSockets
    ...
    public function onOpen(ConnectionInterface $conn, RequestInterface $request = null) {
        ...
        $response = $this->handshakeNegotiator->handshake($request)->withHeader('X-Powered-By', VERSION);
