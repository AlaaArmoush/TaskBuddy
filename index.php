...
<section class="how-it-works-section">
    <div class="container px-4 py-1" id="hanging-icons">
        <h2 class="pb-2 border-bottom animate-hidden">How it works</h2>
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3 stagger-list">
            <div class="col animate-hidden">
...
<section class="social-proof" >
    <div class="container my-5 border">
        <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center ">
            <div class="col-lg-7 p-3 p-lg-5 pt-lg-3 animate-hidden">
                ...
                <ul class="stagger-list">
                    <li class="animate-hidden">Over 500 tasks completed in our first three months</li>
                    <li class="animate-hidden">Local taskers typically respond within 1 hour of your request</li>
                    <li class="animate-hidden">Transparent pricing with no hidden fees - what you see is what you pay</li>
                </ul>
            </div>
            <div class="col-lg-5 offset-lg-0 p-0 overflow-hidden animate-hidden-right">
...
<section class="testimonial">
    <div class="container">
        <h2 class="text-center mb-5 animate-hidden">What Our Clients Say</h2>
        <div class="row stagger-list">
            <div class="col-md-4 mb-4 animate-hidden">
                <div class="card">
...
<section class="book-a-tasker" style="padding-bottom: 100px; padding-top: 100px;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center animate-hidden-bottom">
...
<section class="become-a-tasker" >
    <div class="container py-lg-8">
        <div class="row align-items-center">
            <div class="offset-xl-1 col-xl-4 col-lg-6 d-none d-lg-block animate-hidden">
                <!--img-->
                <div class="position-relative">
                    <img src="images/become-a-tasker.webp" alt=" img" class="img-fluid w-100 rounded-4 become-tasker">
                </div>
            </div>
            <div class="col-xl-6 col-lg-5 offset-lg-1 offset-xl-1 animate-hidden-right">
                <div class="d-flex flex-column gap-6">
                    ...
                    <div class="d-flex flex-column gap-8">
                        <div class="d-flex flex-column gap-5 stagger-list">
                            <div class="row gap-xxl-3 gap-0 animate-hidden">
                            ...
                            <div class="row gap-xxl-3 animate-hidden">
                                <div class="col-md-1 col-lg-2 col-xxl-1 col-2">
